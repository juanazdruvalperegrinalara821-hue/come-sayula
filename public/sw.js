const CACHE='come-sayula-shell-v5';
const SHELL=['/offline.html','/auth.html','/home3.html','/tracking.html','/feedback.html','/manifest.webmanifest','/pwa-install.js','/feedback-launcher.js','/admin-delivery.js','/ui-dialogs.js','/ui-dialogs.css','/ai-assistant.js','/ai-assistant.css','/icons/icon-192.png','/icons/icon-512.png'];
