const CACHE='come-sayula-shell-v1';
const SHELL=['/offline.html','/auth.html','/home3.html','/manifest.webmanifest','/pwa-install.js','/icons/icon-192.png','/icons/icon-512.png'];
