const CACHE='come-sayula-shell-v2';
const SHELL=['/offline.html','/auth.html','/home3.html','/manifest.webmanifest','/pwa-install.js','/ai-assistant.js','/ai-assistant.css','/icons/icon-192.png','/icons/icon-512.png'];
