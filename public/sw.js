const CACHE='come-sayula-shell-v7';
const SHELL=['/offline.html','/auth.html','/home3.html','/tracking.html','/feedback.html','/manifest.webmanifest','/pwa-install.js','/notifications.js','/feedback-launcher.js','/admin-delivery.js','/restaurant-finance.js','/ui-dialogs.js','/ui-dialogs.css','/ai-assistant.js','/ai-assistant.css','/icons/icon-192.png','/icons/icon-512.png'];
